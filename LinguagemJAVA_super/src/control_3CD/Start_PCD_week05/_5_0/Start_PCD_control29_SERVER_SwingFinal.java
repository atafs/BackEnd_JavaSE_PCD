package control_3CD.Start_PCD_week05._5_0;
...
public class Start_PCD_control29_SERVER_SwingFinal {
		...
		public void run() {
			...
			while(true) {
				...
				try {
					...
					/*verifies if there is a repeated user */
					...
					if(accepted) {
						...
						/*zero, one or two are int used to define state_ 1:kikedByServer; 2:serverWhentDown;*/
